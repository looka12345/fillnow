    ...
    <header class="page-header">
        ...
        <div class="right-wrapper pull-right">
            <ol class="breadcrumbs">
                ...
                <li><span>Add App Feature</span></li>
            </ol>
        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title">Add App Feature</h2>
                </header>
                <div class="panel-body">
                    <form action="<?php echo site_url('catalog/homeslidermanage/adddata'); ?>" id="form" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea type="text" name="content" rows="5" id="inputDefault" class="form-control" required ></textarea>
                            </div>
                        </div>
                        <div class="form-group">

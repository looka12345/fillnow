	...
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span><a href="<?php echo site_url("catalog/act"); ?>">Act Management</a></span></li>
				<li><span>Edit Act</span></li>
			</ol>
		...
		<div class="col-lg-12">
			<section class="panel">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Edit Act</h2>
				</header>

				<div class="panel-body">
					<form action="<?php echo site_url('catalog/act/updatedata'); ?>" id="form" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">

						<input type="hidden" name="act_id" value="<?php echo $single_data[0]->act_id;  ?>" />

		...
		<div class="col-lg-12">
			<section class="panel">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Add Act</h2>
				</header>
				
				<div class="panel-body">
					<form action="<?php echo site_url('catalog/act/adddata'); ?>" id="form" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">

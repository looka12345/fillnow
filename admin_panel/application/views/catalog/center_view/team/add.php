		...
		<div class="col-lg-12">
			<section class="panel">
				...
				<div class="panel-body">
					<form action="<?php echo site_url('catalog/teammanage/adddata'); ?>" id="form" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">

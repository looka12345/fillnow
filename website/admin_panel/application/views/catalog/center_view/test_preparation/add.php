	...
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span>Add Test Preparation</span></li>
			</ol>
		...
		<div class="col-lg-12">
			<section class="panel">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Add Test Preparation</h2>
				</header>
				
				<div class="panel-body">
					<form action="<?php echo site_url('catalog/test_preparation/adddata'); ?>" id="form" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="inputDefault" class="col-md-3 control-label">SAT Prep Program:-</label>
							<div class="col-md-9">
								<textarea class="form-control" name="sat" id="summernote" ></textarea>
							</div>
						</div>

	...
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span><a href="<?php echo site_url("catalog/test_preparation"); ?>">Test Preparation Management</a></span></li>
				<li><span>Edit Test Preparation</span></li>
			</ol>
		...
		<div class="col-lg-12">
			<section class="panel">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Edit Test Preparation</h2>
				</header>

				<div class="panel-body">
					<form action="<?php echo site_url('catalog/test_preparation/updatedata'); ?>" id="form" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">

						<input type="hidden" name="test_preparation_id" value="<?php echo $single_data[0]->test_preparation_id;  ?>" />
						...
						<div class="form-group">
							...
							<div class="col-md-9"> 
								<textarea class="form-control" name="sat" id="summernote" ><?=$single_data[0]->sat?></textarea>
							</div>
						</div>
						<div class="form-group">

		...
		<div class="col-lg-12">
			<section class="panel">
				...
				<div class="panel-body">
					<form action="<?php echo site_url('catalog/gallery/adddata'); ?>" id="form" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								...
								foreach ($pack_list as $cat_id => $category) {?>
								  <option value="<?=$category->products_id?>"><?=$category->name?></option>
								  <?php } ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" name="path" id="inputDefault" class="form-control" >

		...
		<div class="col-lg-12">
			<section class="panel">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Add Download</h2>
				</header>
				
				<div class="panel-body">
					<form action="<?php echo site_url('catalog/placement/adddata'); ?>" id="form" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="file" name="file" id="inputDefault" class="form-control" required >

<section class="content-body" role="main">
	...
	<header class="page-header">
		...
		<h2>Home Feature Slider Management</h2>
		...
		<div class="right-wrapper pull-right">
			...
			<ol class="breadcrumbs">
				...
				<li><span>Home Feature Slider Management</span></li>
	...
	<section class="panel">
		...
		<div class="panel-body">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<div class="mb-md">
						...
						<a href="<?php echo site_url("catalog/clientslider/add"); ?>" >Add</a> <i class="fa fa-plus"></i>
			...
			<tbody>
				...
				if(isset($clientslider_arr) && !empty($clientslider_arr)) { ?>

				<?php foreach($clientslider_arr as $value) { ?>

				<tr  role="row">

					<td class="sorting_1"><?php echo ucfirst($value->name); ?></td>

					<td class="sorting_1"><?php if(isset($value->image) && !empty($value->image)) { ?> <img src="<?php echo site_url("../assets/sitesfile/image/client")."/".$value->image;?>" height="100" width="100" /><?php } ?></td>

					<td class="actions">

						<?php if($value->active_status==1){ ?>

						<img src="<?php echo site_url("assets/images/icons")."/active.png"; ?>" onclick="changeStatus(<?php echo $value->client_slider_id; ?>,'client_slider',1)" title="status" />

						<?php }else{ ?>

						<img src="<?php echo site_url("assets/images/icons")."/deactive.png"; ?>" onclick="changeStatus(<?php echo $value->client_slider_id; ?>,'client_slider',0)" title="status" />

						<?php } ?>

						<a class="on-default edit-row" href="<?php echo site_url("catalog/clientslider/edit")."/".$value->client_slider_id 	; ?>"><i class="fa fa-pencil"></i></a>

						<a class="on-default remove-row" onclick="recordAddToTrace(this,'<?php echo $value->client_slider_id 	 ?>','client_slider','<?php echo $value->delete_status?>','1')"><i class="fa fa-trash-o"></i></a>

						</td><td>	<input type="text"  id="priority<?php echo $value->client_slider_id ?>" size="1" value="<?=$value->priority?>" />

						<input type="button" id="save" onclick="setpriority('priority<?php echo $value->client_slider_id ?>',<?php echo $value->client_slider_id ?>,'client_slider')"  value="Update" />			</td>

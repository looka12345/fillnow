	...
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span>Add Subject Test</span></li>
			</ol>
		...
		<div class="col-lg-12">
			<section class="panel">
				<header class="panel-heading">
					<div class="panel-subject_testions">
						<a class="fa fa-caret-down" href="#"></a>
					</div>
					<h2 class="panel-title">Add Subject Test</h2>
				</header>
				
				<div class="panel-body">
					<form action="<?php echo site_url('catalog/subject_test/adddata'); ?>" id="form" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label for="inputDefault" class="col-md-3 control-label">About:-</label>
							<div class="col-md-9">

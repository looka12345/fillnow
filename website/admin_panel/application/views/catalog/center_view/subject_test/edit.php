	...
	<header class="page-header">
		...
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span><a href="<?php echo site_url("catalog/subject_test"); ?>">Subject Test Management</a></span></li>
				<li><span>Edit Subject Test</span></li>
			</ol>
		...
		<div class="col-lg-12">
			<section class="panel">
				<header class="panel-heading">
					...
					<h2 class="panel-title">Edit Subject Test</h2>
				</header>

				<div class="panel-body">
					<form action="<?php echo site_url('catalog/subject_test/updatedata'); ?>" id="form" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">

						<input type="hidden" name="subject_test_id" value="<?php echo $single_data[0]->subject_test_id;  ?>" />
						...
						<div class="form-group">
							...
							<div class="col-md-9"> 
								<textarea class="form-control" name="about" id="summernote" ><?=$single_data[0]->about?></textarea>
							</div>
						</div>
						<div class="form-group">

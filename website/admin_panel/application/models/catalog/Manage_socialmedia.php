<?php
 ...
 class Manage_socialmedia extends CI_Model
...

{
    ...
    $this->db->from("socialmedia sc");

	$this->db->order_by("sc.priority", "ASC"); 

	if($searchuser!=0)

	{

	  $this->db->where("sc.admin_login_id",$searchuser);	
...
function updateData($data)
	...
	if($this->db->update('socialmedia',$data))

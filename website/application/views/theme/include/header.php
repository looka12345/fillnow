...
<ul class="list-inline">
    <li>
        <a href="https://fms.synergyteletech.com/ofo/Login?type=CustomerLogin" target="_blank" class="btn btn-secondary4" tabindex="0">Customer Login</a>
    </li>
    <li>
        <a href="https://fms.synergyteletech.com/ofo/Login?type=PartnerLogin" target="_blank" class="btn btn-secondary4" tabindex="0">Partner Login</a>
    </li>
    <li>
    ...
    <li>
        <!--<a href="//<//?=$social_info->//twitter?>">-->
            <a target="_blank" href="https://twitter.com/fillnow_in">
            <i class="fa fa-twitter fa-fw" aria-hidden="true"></i>
        </a>
    </li>
    <li>
        <a target="_blank" href="https://www.linkedin.com/company/synergy-teletech-private-limited/">
        <!--<a href="//<//?=$social_info->//linkedin?>">-->
            <i class="fa fa-linkedin fa-fw" aria-hidden="true"></i>
        </a>
    </li>
    <li>
        <a target="_blank" href="<?=$social_info->google?>">
